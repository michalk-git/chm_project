...
# installed.
TK_PREFIX='C:/tools/tcl_8.6'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TK_EXEC_PREFIX='C:/tools/tcl_8.6'
...
# String to pass to linker to pick up the Tk library from its
# installed directory.
TK_LIB_SPEC='-LC:/tools/tcl_8.6/lib -ltk86'
...
# String to pass to linker to pick up the Tk stub library from its
# installed directory.
TK_STUB_LIB_SPEC='-LC:/tools/tcl_8.6/lib -ltkstub86'
...
TK_STUB_LIB_PATH='C:/tools/tcl_8.6/lib/tkstub86.lib'
