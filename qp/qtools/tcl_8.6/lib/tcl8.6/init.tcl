...
#
# ActiveState ActiveTcl 8.6.4.1.299124 Win32/x86, Sat Jun 06 01:40:47 PDT 2015
#
...
namespace eval ::activestate {
	...
	maturity      {final}
	arch          {win32-ix86}
	buildtime,sec {1433580047}
	buildtime,fmt {Sat Jun 06 01:40:47 PDT 2015}
	as,mode       {normal}
    }
    ...
    variable  config
    array set config {
	{ActiveTcl} {ActiveState ActiveTcl 8.6.4.1.299124 Win32/x86 @ Sat Jun 06 01:40:47 PDT 2015 ef02e1dfd92a04054f9ae123fe7e498f793963ff / normal}
    }
}
